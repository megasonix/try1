...
public class Results extends AppCompatActivity {
    ...
    private DatabaseReference mDatabaseRef = FirebaseDatabase.getInstance().getReference("Images");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        history = (ImageButton) findViewById(R.id.imageButton4);
//        setting =(FloatingActionButton) findViewById(R.id.set_btn);
            ...
            fileReference.putFile(uri).continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful())
                    {
                        ...
                        fireUpload upload = new fireUpload(mImageDetails.getText().toString().trim(),
                                downloadUri.toString());

                        mDatabaseRef.push().setValue(upload);
                    } else {
                        Toast.makeText(Results.this, "upload failed: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }
            });
        } else {
    ...
    private void openImageHistory() {
        Intent intent = new Intent(this, ImagesHistory.class);
